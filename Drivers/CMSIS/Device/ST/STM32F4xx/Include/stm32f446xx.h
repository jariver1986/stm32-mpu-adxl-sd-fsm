...
typedef struct {
    ...
    __IO uint32_t
        CFGR; /*!< SYSCFG Configuration register,                     Address offset: 0x2C      */
} SYSCFG_TypeDef;
...
#define FMC_R_BASE                                                                                 \
    0xA0000000UL /*!< FMC registers base address */
#define QSPI_R_BASE                                                                                \
    0xA0001000UL /*!< QuadSPI registers base address */
...
#define FMC_PMEM_MEMWAIT2                                                                          \
    FMC_PMEM_MEMWAIT2_Msk /*!<MEMWAIT2[7:0] bits (Common memory 2 wait time) */
...
#define FMC_PMEM_MEMHOLD2                                                                          \
    FMC_PMEM_MEMHOLD2_Msk /*!<MEMHOLD2[7:0] bits (Common memory 2 hold time) */
...
#define FMC_PMEM_MEMHIZ2                                                                           \
    FMC_PMEM_MEMHIZ2_Msk /*!<MEMHIZ2[7:0] bits (Common memory 2 databus HiZ time) */
...
#define FMC_PATT_ATTSET2                                                                           \
    FMC_PATT_ATTSET2_Msk /*!<ATTSET2[7:0] bits (Attribute memory 2 setup time) */
...
#define FMC_PATT_ATTWAIT2                                                                          \
    FMC_PATT_ATTWAIT2_Msk /*!<ATTWAIT2[7:0] bits (Attribute memory 2 wait time) */
...
#define FMC_PATT_ATTHOLD2                                                                          \
    FMC_PATT_ATTHOLD2_Msk /*!<ATTHOLD2[7:0] bits (Attribute memory 2 hold time) */
...
#define FMC_PATT_ATTHIZ2                                                                           \
    FMC_PATT_ATTHIZ2_Msk /*!<ATTHIZ2[7:0] bits (Attribute memory 2 databus HiZ time) */
...
#define FMPI2C_CR2_HEAD10R                                                                         \
    FMPI2C_CR2_HEAD10R_Msk /*!< 10-bit address header only read direction (master mode) */
...
#define PWR_CR_LPLVDS                                                                              \
    PWR_CR_LPLVDS_Msk /*!< Low-Power Regulator Low Voltage Scaling in Stop mode       */
#define PWR_CR_MRLVDS_Pos (11U)
#define PWR_CR_MRLVDS_Msk (0x1UL << PWR_CR_MRLVDS_Pos) /*!< 0x00000800 */
#define PWR_CR_MRLVDS                                                                              \
    PWR_CR_MRLVDS_Msk /*!< Main regulator Low Voltage Scaling in Stop mode            */
...
#define SPDIFRX_CR_SPDIFEN                                                                         \
    SPDIFRX_CR_SPDIFEN_Msk /*!<Peripheral Block Enable                      */
...
#define SPDIFRX_CR_RXDMAEN                                                                         \
    SPDIFRX_CR_RXDMAEN_Msk /*!<Receiver DMA Enable for data flow            */
...
#define SPDIFRX_CR_CBDMAEN                                                                         \
    SPDIFRX_CR_CBDMAEN_Msk /*!<Control Buffer DMA ENable for control flow   */
...
#define SPDIFRX_CR_NBTR                                                                            \
    SPDIFRX_CR_NBTR_Msk /*!<Maximum allowed re-tries during synchronization phase */
...
#define SPDIFRX_IMR_RXNEIE                                                                         \
    SPDIFRX_IMR_RXNEIE_Msk /*!<RXNE interrupt enable                              */
...
#define SPDIFRX_IMR_CSRNEIE                                                                        \
    SPDIFRX_IMR_CSRNEIE_Msk /*!<Control Buffer Ready Interrupt Enable              */
...
#define SPDIFRX_IMR_PERRIE                                                                         \
    SPDIFRX_IMR_PERRIE_Msk /*!<Parity error interrupt enable                      */
...
#define SPDIFRX_IMR_OVRIE                                                                          \
    SPDIFRX_IMR_OVRIE_Msk /*!<Overrun error Interrupt Enable                     */
...
#define SPDIFRX_IMR_SBLKIE                                                                         \
    SPDIFRX_IMR_SBLKIE_Msk /*!<Synchronization Block Detected Interrupt Enable    */
...
#define SPDIFRX_IMR_IFEIE                                                                          \
    SPDIFRX_IMR_IFEIE_Msk /*!<Serial Interface Error Interrupt Enable            */
...
#define SPDIFRX_SR_WIDTH5                                                                          \
    SPDIFRX_SR_WIDTH5_Msk /*!<Duration of 5 symbols counted with SPDIFRX_clk        */
...
#define SPDIFRX_IFCR_PERRCF                                                                        \
    SPDIFRX_IFCR_PERRCF_Msk /*!<Clears the Parity error flag                         */
...
#define SPDIFRX_IFCR_OVRCF                                                                         \
    SPDIFRX_IFCR_OVRCF_Msk /*!<Clears the Overrun error flag                        */
...
#define SPDIFRX_IFCR_SBDCF                                                                         \
    SPDIFRX_IFCR_SBDCF_Msk /*!<Clears the Synchronization Block Detected flag       */
...
#define SPDIFRX_IFCR_SYNCDCF                                                                       \
    SPDIFRX_IFCR_SYNCDCF_Msk /*!<Clears the Synchronization Done flag                 */
...
#define RCC_MAX_FREQUENCY_SCALE2                                                                   \
    168000000U /*!< Maximum frequency for system clock at power scale2, in Hz */
#define RCC_MAX_FREQUENCY_SCALE3                                                                   \
    120000000U /*!< Maximum frequency for system clock at power scale3, in Hz */
